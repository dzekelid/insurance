...
- name: Healthcare.gov Get API Articles Media Type Extension
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/healthcaregov/api-articles-mediatypeextension-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/healthcaregov/api-articles-mediatypeextension-get-postman.md
x-common:
- type: x-developer
