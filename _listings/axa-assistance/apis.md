...
- name: AXA Assistance Resends the confirmation email to an identity account
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/axa-assistance/user-v1-identities-register-confirm-resend-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/axa-assistance/user-v1-identities-register-confirm-resend-post-postman.md
x-common:
- type: x-crunchbase
