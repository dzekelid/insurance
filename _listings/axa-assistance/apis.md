...
- name: 'AXA Assistance Retrieve all medical provider kinds available for search (Ex:
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/axa-assistance/ondemand-v1-medical-providers-kinds-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/insurance/master/_listings/axa-assistance/ondemand-v1-medical-providers-kinds-get-postman.md
x-common:
- type: x-crunchbase
